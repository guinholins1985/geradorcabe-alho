...
export const LogoIcon: React.FC = () => (
    <svg className="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19.5V4.5m6 15V4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3.75 9h16.5M3.75 15h16.5" />
    </svg>
);
...
export const ResetIcon: React.FC = () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h5M20 20v-5h-5M4 9a9 9 0 0114.13-5.26M20 15a9 9 0 01-14.13 5.26" />
    </svg>
);
